		...
		<div class="row row-cols-1 row-cols-md-3 g-4">
			...
			<div class="col" onclick="location.href='goodsView.jsp?num=<%=list.get(i).getNum()%>'">
				<div class="card h-100 " style="">
					<img src="uploadImage/image/<%=list.get(i).getFileName()%>" class="card-img-top" style="width:414px; height:300px; margin: auto;"alt="...">
					<div class="card-body">
						<h5 class="card-title"><%=list.get(i).getSubject()%></h5>
						<p class="card-text">가격:<%=list.get(i).getPrice()%>원</p>
						<%-- <p class="card-text">상품 내용:<%=list.get(i).getContent()%></p> --%>
					</div>
				</div>
			</div>
