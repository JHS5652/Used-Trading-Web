...
<head>
<meta charset="UTF-8">
<title>acount_MemberGoods</title>
<link
...
<body>
	...
	String st = (String)request.getParameter("memberID");
	%>
	...
	<section class="container">
		...
		<h1 class="text-center "><%=st %>님의 중고 물품 리스트</h1>

		<div class="row row-cols-1 row-cols-md-3 g-4">

			<%
			GoodsListDAO glDAO = new GoodsListDAO();
			ArrayList<GoodsListDTO> list = glDAO.getUserList(st);
			int s = list.size();
